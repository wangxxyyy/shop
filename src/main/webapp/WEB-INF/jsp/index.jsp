...
<head>
	...
	<body id="top">
		...
		<div class="focus">
			...
			<div class="dd-inner">
				<!-- 第一级循环-->
				<c:forEach var="goodsClassify" items="${list}" >
					<div class="font-item">
						...
						<div class="font-item1">
							<div class="font-lefty">
								<!-- 第二级循环-->
								<c:forEach var="goodsClassify1" items="${goodsClassify}" >
									<dl class="fore1">
										<dt><a href="">${goodsClassify1.name}<i>></i></a></dt>
										<dd>
											<!-- 第三级循环-->
											<c:forEach var="goodsClassify2" items="${goodsClassify1.children}" >
											  <a href="commodity/commodityHome?goodsClassfyId=${goodsClassify2.id}" target="_blank" onclick="">${goodsClassify2.name}</a>
											</c:forEach>
										</dd>
									</dl>
								</c:forEach>
